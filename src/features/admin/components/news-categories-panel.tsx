...
} from "@/features/admin/actions/news-categories";
import { ToggleSwitch } from "./toggle-switch";

interface NewsCategoriesPanelProps {
  categories: NewsCategoryRow[];
}

/** SuperAdmin editor for the news article form's category picker. */
export function NewsCategoriesPanel({ categories }: NewsCategoriesPanelProps) {
  ...
  function startEdit(category: NewsCategoryRow) {
    setError(null);
        ...
        <div className="mb-4 flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm text-ink-600">
              The list staff pick from when writing a news article. Retiring a category hides
              it from the form; past articles keep it.
            </p>
          </div>
