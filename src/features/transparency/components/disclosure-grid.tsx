  ...
  return (
    <Section id="documents">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
        <Card className="rounded-xl p-8 md:col-span-12 lg:col-span-8">
          <div className="mb-6 flex items-start justify-between">
            <span className="rounded-xl bg-accent-soft p-4 text-primary">
        ...
        <Card className="rounded-xl p-8 md:col-span-6 lg:col-span-4">
          <span className="mb-6 inline-block rounded-xl bg-blue-50 p-4 text-secondary">
              ...
              <li key={project.name} className="flex items-center gap-3 text-sm">
                <span
                  className={cn(
                    ...
                    project.progress === 100 ? "bg-green-500" : "bg-yellow-500",
                  )}
                  aria-hidden="true"
                />
                <span>
        ...
        <Card className="rounded-xl p-8 md:col-span-6 lg:col-span-4">
          <span className="mb-6 inline-block rounded-xl bg-danger-soft p-4 text-danger">
        ...
        <div className="flex flex-col justify-between rounded-xl bg-primary p-8 text-white md:col-span-12 lg:col-span-8">
          <div>
          ...
          <form className="flex flex-col items-center gap-4 md:flex-row" action="#">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full rounded-lg bg-white py-3 pl-12 pr-4 text-ink focus:outline-none focus:ring-2 focus:ring-accent-muted"
              />
            </div>
            <Button type="submit" variant="white" size="lg" className="w-full whitespace-nowrap md:w-auto">
              Search Database
            </Button>
          </form>
        </div>
